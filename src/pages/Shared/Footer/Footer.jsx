    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto py-4 px-6 flex flex-col md:flex-row items-center justify-between">
        <div className="text-center md:text-left">
          <h2 className="text-2xl font-bold mb-2">Turbo Troop</h2>
          <p className="text-sm">
            The ultimate destination for toy car enthusiasts
          </p>
          <p className="text-sm mt-4">1234 Toy Street, City, Country</p>
        </div>
      ...
      <div className="bg-gray-800 py-2 text-center">
        <p className="text-xs text-gray-500">
          &copy; {new Date().getFullYear()} Turbo Troop. All rights reserved.
